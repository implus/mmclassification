...
class SEMSBottleneck(nn.Module):
  ...
  def __init__(self, inplanes, planes, cardinality, base_width, stride=1, downsample=None, depth = 4):
    ...
    self.se = SELayer(planes*4, ratio=5)
...
class CifarResNeXt(nn.Module):
    ...
    """
    def __init__(self, block, depth, cardinality, base_width, scale):
...
class SERes2NeXt29(CifarResNeXt):
    def __init__(self, block=SEMSBottleneck, depth=29, cardinality=6, base_width=24, scale=6):
        super().__init__(block, depth, cardinality, base_width, scale)
