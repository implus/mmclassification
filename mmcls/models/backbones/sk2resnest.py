...
class OldSplitAttentionConv2d(nn.Module):
    ...
    def __init__(self,
        ...
        super(OldSplitAttentionConv2d, self).__init__()
...
class Bottleneck(_Bottleneck):
    ...
    def __init__(self,
        ...
        self.conv1 = build_conv_layer(
            ...
            bias=False)
        self.add_module(self.norm1_name, norm1)
        conv2_stride = 1 if self.avg_down_stride else self.conv2_stride,
        if conv2_stride[0] > 1 and self.avg_down_stride == False:
            self.conv2 = OldSplitAttentionConv2d(
                self.mid_channels,
                self.mid_channels,
                kernel_size=3,
...
class SK2ResNeSt(ResNet):
    ...
    def __init__(self,
        ...
        super(SK2ResNeSt, self).__init__(depth=depth,
