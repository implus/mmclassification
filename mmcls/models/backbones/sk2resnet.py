...
class SK2Conv2d(nn.Module):
    ...
    Args:
        ...
        reduction_factor (int): Reduction factor of SK2Conv2d.
            Default: 4.
    ...
    def __init__(self,
        ...
        super(SK2Conv2d, self).__init__()
        assert groups == 1
        inter_channels = max(in_channels * 2 // reduction_factor, 32)
        self.groups = groups
        ...
        self.fc2 = build_conv_layer(
            None, inter_channels, channels, 1, groups=self.groups, bias=True)
        alpha_dim = channels if attn_channel else 1
        self.register_parameter('alpha', nn.Parameter(torch.zeros(1, alpha_dim, 1, 1)))
    ...
    def forward(self, x):
        ...
        gap = a * F.adaptive_avg_pool2d(x, 1) + \
              (1. - a) * F.adaptive_avg_pool2d(old_x, 1)
        gap = self.fc1(gap)
...
class Bottleneck(_Bottleneck):
    ...
    def __init__(self,
        ...
        self.avg_down_stride = (self.conv2_stride > 1)
        ...
        self.conv2 = SK2Conv2d(
            self.mid_channels,
            self.mid_channels,
            kernel_size=3,
            stride=1,  # not conv2_stride, always 1
...
class SK2ResNet(ResNet):
    ...
    def __init__(self,
        ...
        super(SK2ResNet, self).__init__(depth=depth,
    ...
    def make_res_layer(self, **kwargs):
        return ResLayer(
            ...
            attn_channel=self.attn_channel,
            **kwargs)
