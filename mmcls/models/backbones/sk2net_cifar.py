...
class SK2Net_CIFAR(SK2Net):
    ...
    def __init__(self, depth, deep_stem=False, **kwargs):
        super(SK2Net_CIFAR, self).__init__(
            depth=depth, deep_stem=deep_stem, **kwargs)
        assert not self.deep_stem, 'SK2Net_CIFAR do not support deep_stem'
