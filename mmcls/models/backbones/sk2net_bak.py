...
class SK2Layer(nn.Module):
    def __init__(self, inplanes, ratio=13, stride=1, groups=3) -> None:
        super(SK2Layer, self).__init__()
    ...
    def forward(self, x, fx):
        if self.sk_downsample is not None:
...
class SKBottle2neck(_Bottleneck):
    expansion = 4
    ...
    def __init__(self,
                 ...
                 stage_type='normal',
                 **kwargs):
        """SKBottle2neck block for SK2Net.
        ...
        super(SKBottle2neck, self).__init__(inplanes, planes, **kwargs)
        ...
        self.sk = SK2Layer(width * (scales - 1), ratio, self.conv2_stride, scales - 1)
...
class Res2Layer(nn.Sequential):
    ...
    def __init__(self,
        ...
        planes = out_channels // block.expansion
...
class SK2Net(ResNet):
    ...
    Args:
        ...
        base_width (int): Basic width of each scale. Default: 26
        depth (int): Depth of sk2net, from {50, 101, 152}.
    ...
    Example:
        >>> from mmcls.models import SK2Net
        >>> import torch
        >>> self = SK2Net(depth=50, scales=4, base_width=26, ratio=13)
        >>> self.eval()
    ...
    arch_settings = {
        50: (SKBottle2neck, (3, 4, 6, 3)),
        101: (SKBottle2neck, (3, 4, 23, 3)),
        152: (SKBottle2neck, (3, 8, 36, 3))
    }
